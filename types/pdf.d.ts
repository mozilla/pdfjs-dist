...
import { DocumentInitParameters } from "./display/api.js";
import { LoopbackPort } from "./display/api.js";
import { PDFDataRangeTransport } from "./display/api.js";
import { PDFDocumentProxy } from "./display/api.js";
import { PDFPageProxy } from "./display/api.js";
...
export { addLinkAttributes, getFilenameFromUrl, LinkTarget, loadScript, PDFDateString, RenderingCancelledException, build, getDocument, DocumentInitParameters, LoopbackPort, PDFDataRangeTransport, PDFDocumentProxy, PDFPageProxy, PDFWorker, version, CMapCompressionType, createObjectURL, createPromiseCapability, createValidAbsoluteUrl, InvalidPDFException, MissingPDFException, OPS, PasswordResponses, PermissionFlag, removeNullCharacters, shadow, UnexpectedResponseException, UNSUPPORTED_FEATURES, Util, VerbosityLevel, AnnotationLayer, apiCompatibilityParams, GlobalWorkerOptions, renderTextLayer, SVGGraphics };
